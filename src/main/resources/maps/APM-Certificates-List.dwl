...
---
{
	certificates: payload map ( payload01 , indexOfPayload01 ) -> {
		...
		partnerName: if(vars.apmProfilesFound == 'true') vars.apmPartners[?($.partnerId == payload01.partnerId)][0].partnerName else "UNKNOWN",
		partnerEmail:  if(vars.apmProfilesFound == 'true') vars.apmPartners[?($.partnerId == payload01.partnerId)][0].partnerEmail else "UNKNOWN",
		partnerPhone:  if(vars.apmProfilesFound == 'true') vars.apmPartners[?($.partnerId == payload01.partnerId)][0].partnerPhone else "UNKNOWN",
